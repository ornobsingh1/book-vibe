...
const Navbar = () => {
  const link = (
    <>
      <NavLink className="p-2 font-semibold">Home</NavLink>
      <NavLink className="p-2 font-semibold">Listed Books</NavLink>
      <NavLink className="p-2 font-semibold">Pages to Read</NavLink>
    </>
  );
